...
' --- Messages -------------------------------------------------
lblBig# = label#(frm#, "", 0, GAME_H / 2 - 60, GAME_W, 44)
label_fontsize#(lblBig#, 30)
label_bold#(lblBig#, 1)
label_textalign#(lblBig#, 1)
label_fontcolor#(lblBig#, INK$)

lblSmall# = label#(frm#, "", 0, GAME_H / 2 - 12, GAME_W, 30)
...
function DiveY(idx, t)
  return SlotY(idx) + (GAME_H + 60 - SlotY(idx)) * t * t
end function
